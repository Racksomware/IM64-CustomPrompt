...
func _ready():
	...
	new_star_mat.set_shader_parameter("albedo_texture", preload("res://mario/textures/env_map_shiny_blurry.png"))
	if star_gotten:
		new_star_mat.set_shader_parameter("albedo", Color(0.05, 0.1, 0.3, 0.75))
		new_star_mat.set_shader_parameter("albedo_texture", preload("res://mario/textures/env_map_balanced.png"))
...
var star_spawn_height_curve := preload("res://mario/objects/star_spawn_height_curve.tres") as Curve
var star_spawn_horizontal_curve := preload("res://mario/objects/star_spawn_horizontal_curve.tres") as Curve
...
func _respawn():
	...
	if star_gotten:
		...
		shader_mat.set_shader_parameter("albedo_texture", preload("res://mario/textures/env_map_balanced.png"))
